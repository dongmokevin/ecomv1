...
class RegistrationForm(forms.ModelForm):
    ...
    #     label='Enter a valid UK Phone Number', min_length=4, max_length=60, help_text='Required')
...
class UserEditForm(forms.ModelForm):
    ...
    first_name = forms.CharField(
        label='Name', min_length=4, max_length=50, widget=forms.TextInput(
            attrs={'class': 'form-control mb-3', 'placeholder': 'Firstname and Lastname', 'id': 'form-lastname'}))
    # phone_number = forms.CharField(
    #     label='Phone Number', min_length=4, max_length=50, widget=forms.TextInput(
    #         attrs={'class': 'form-control mb-3', 'placeholder': 'Phone Number', 'id': 'phone_number'}))
